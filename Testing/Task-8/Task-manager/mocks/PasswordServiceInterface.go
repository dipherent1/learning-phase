...
// CheckPassword provides a mock function with given fields: existingPassword, loginPassword
func (_m *PasswordServiceInterface) CheckPassword(existingPassword string, loginPassword string) error {
	ret := _m.Called(existingPassword, loginPassword)
	...
	if rf, ok := ret.Get(0).(func(string, string) error); ok {
		r0 = rf(existingPassword, loginPassword)
	} else {
		r0 = ret.Error(0)
	}
